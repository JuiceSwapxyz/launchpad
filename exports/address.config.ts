...
export interface LaunchpadAddresses {
  ...
  baseAsset: Address;
  /** Permit2 contract address used for signature-based dev buys */
  permit2: Address;
  ...
  /** Previous factory deployments to keep indexing legacy launchpad tokens */
  legacyFactories?: readonly Address[];
}
...
export const ADDRESS: Record<number, LaunchpadAddresses> = {
  ...
  5115: {
    ...
    permit2: DEFAULT_PERMIT2_ADDRESS,
    ...
    initCodeHash:
      "0xdc3b9f52403077ec7261ad325e15f34e395cf7e2a5c3782098edb10a7599cc3e",
  },
